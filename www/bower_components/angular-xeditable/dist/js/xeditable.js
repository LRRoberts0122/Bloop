  ...
  function(editableDirectiveFactory) {
    return editableDirectiveFactory({
      ...
      autosubmit: function() {
        ...
        self.inputEl.bind('change', function() {
          self.scope.$apply(function() {
	        self.scope.saveData(self.scope.$data, self.scope.$form.$editables[0].name);
            self.scope.$form.$submit();
          });
        });
      }
...
angular.module('xeditable').factory('editableThemes', function() {
  var themes = {
    ...
    'default': {
      ...
      submitTpl:   '<button type="submit" class="btn btn-primary" ng-click="saveData($data, $form.$editables[0].name)"><i class="fa fa-check"></i></button>',
